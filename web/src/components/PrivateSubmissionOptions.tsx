  ...
  return (
    <div className="space-y-8">
      <div className="text-center">
        <h2 className="text-4xl font-bold mb-4 text-foreground">Submit Leak to Verified Groups</h2>
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-2">
          Choose to disclose
        </p>
        <div className="flex items-center justify-center space-x-2 flex-wrap gap-2">
          <Badge variant="outline" className="border-primary text-primary px-4 py-2 text-base font-medium">
            ...
            <CardHeader className="pb-4">
              <div className="flex items-start justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <CardTitle className="text-foreground text-lg font-semibold">{group.title}</CardTitle>
                    <p className="text-sm text-muted-foreground mt-1">{group.count}</p>
                  </div>
                </div>
                {group.comingSoon && (
                  <Badge className="bg-yellow-100/60 text-yellow-700 border-yellow-300 text-xs">
                    Coming Soon
                  </Badge>
                )}
              </div>
